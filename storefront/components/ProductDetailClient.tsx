...
import { ShoppingBag, ArrowRight, ArrowLeft, Ruler, Loader2, Ban } from 'lucide-react';
...
export default function ProductDetailClient({ product, relatedProducts, id }: ProductDetailClientProps) {
