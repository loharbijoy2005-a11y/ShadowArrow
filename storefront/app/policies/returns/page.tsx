    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-16 w-full space-y-8">
        <div className="border-b border-slate-800 pb-6 space-y-2">
          ...
          <h1 className="text-3xl sm:text-4xl font-black uppercase text-white tracking-tight">Return & Refund Policy</h1>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 sm:p-10 shadow-2xl space-y-8 text-sm text-slate-300 leading-relaxed font-sans">
          ...
          <section className="space-y-3">
            ...
            <ol className="list-decimal list-inside space-y-2 text-slate-300 pl-2">
              <li>Contact our customer support team at <strong className="text-blue-400">support.shadowarrow@gmail.com</strong> or interact with Shadow AI Stylist on the storefront. Provide your Order ID (format: <code>SA-YYYYMMDD-XXXX</code>) and reason for return.</li>
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 p-4 bg-slate-950 rounded-2xl border border-slate-800 text-xs font-mono">
              <div className="space-y-1">
                <p className="font-bold text-white uppercase">Prepaid Orders (Razorpay UPI / Cards)</p>
                <p className="text-emerald-400 font-bold">5 to 7 Business Days</p>
                <p className="text-[10px] text-slate-500">Direct credit back to the original source Bank Account / Card / UPI VPA.</p>
              </div>
              <div className="space-y-1">
                <p className="font-bold text-white uppercase">Cash on Delivery (COD) Orders</p>
                <p className="text-blue-400 font-bold">5 to 7 Business Days</p>
            ...
            <div className="p-4 bg-slate-950 rounded-2xl border border-slate-800 text-xs font-mono space-y-1 mt-4">
              <p className="font-bold text-white uppercase">SHADOW ARROW Returns & Refunds Desk</p>
              <p className="text-slate-400">Support Hours: Monday – Saturday (10:00 AM – 7:00 PM IST)</p>
              <p className="text-blue-400 font-bold">Support Email: support.shadowarrow@gmail.com</p>
            </div>
          </section>
        </div>
      </main>
