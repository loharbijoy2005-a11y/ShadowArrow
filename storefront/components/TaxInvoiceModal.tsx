...
export default function TaxInvoiceModal({ order, onClose }: TaxInvoiceModalProps) {
  ...
  const renderQRCodeSVG = () => (
    <svg className="w-16 h-16 bg-white p-1 border border-slate-300 rounded" viewBox="0 0 100 100" fill="currentColor">
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-2 sm:p-4 font-sans">
      ...
      <div className="bg-white text-slate-900 rounded-2xl max-w-2xl w-full p-6 shadow-2xl relative border border-slate-300 max-h-[95vh] overflow-y-auto">
        ...
        {/* Professional E-Commerce Tax Invoice Container (Flipkart/Amazon Layout) */}
        <div id="invoice-printable-area" className="mt-4 p-4 bg-white border border-slate-300 rounded-xl space-y-4 text-xs leading-normal text-slate-900">
          
          {/* Header Bar */}
          <div className="flex justify-between items-start border-b-2 border-slate-900 pb-3">
            <div>
              <h1 className="text-2xl font-black tracking-tight text-slate-900 font-mono">SHADOW ARROW</h1>
              <p className="text-[10px] font-bold text-slate-600 uppercase tracking-wider font-mono">OFFICIAL GST TAX INVOICE / BILL OF SUPPLY</p>
          ...
          {/* Sold By Seller Info vs Order Metadata Grid */}
          <div className="grid grid-cols-2 gap-3 text-[11px] font-mono">
            ...
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-200 text-right space-y-0.5">
          ...
          <div className="grid grid-cols-2 gap-3 text-[11px] font-mono">
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
              <p className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Billing Address (Bill To)</p>
          ...
          <div className="flex justify-between items-start pt-2 font-mono text-[11px]">
            ...
            <div className="w-56 bg-slate-50 p-3 rounded-lg border border-slate-200 space-y-1">
          ...
          <div className="pt-3 border-t border-slate-200 flex justify-between items-center text-[9px] font-mono text-slate-500">
            <div>
