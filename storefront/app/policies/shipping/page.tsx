    ...
    <div className="min-h-screen flex flex-col bg-slate-950 text-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 py-16 w-full space-y-8">
        <div className="border-b border-slate-800 pb-6 space-y-2">
          ...
          <h1 className="text-3xl sm:text-4xl font-black uppercase text-white tracking-tight">Shipping & Delivery Policy</h1>
          <p className="text-xs text-slate-400 font-mono">Effective Date: August 16, 2026 • SHADOW ARROW Pan-India Express</p>
        </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 sm:p-10 shadow-2xl space-y-8 text-sm text-slate-300 leading-relaxed font-sans">
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 p-4 bg-slate-950 rounded-2xl border border-slate-800 text-xs font-mono">
              <div className="space-y-1">
                <p className="font-bold text-white uppercase">Metro Cities</p>
                <p className="text-blue-400 font-bold">2 to 4 Business Days</p>
                <p className="text-[10px] text-slate-500">Delhi NCR, Mumbai, Bengaluru, Kolkata, Chennai, Hyderabad</p>
              </div>
              <div className="space-y-1">
                <p className="font-bold text-white uppercase">Tier 2 & 3 Cities</p>
                <p className="text-purple-400 font-bold">3 to 6 Business Days</p>
                <p className="text-[10px] text-slate-500">State Capitals & Major Urban Towns</p>
              </div>
              <div className="space-y-1">
                <p className="font-bold text-white uppercase">Rest of India & Special Regions</p>
                <p className="text-amber-400 font-bold">5 to 7 Business Days</p>
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 bg-slate-950 rounded-2xl border border-slate-800 text-xs font-mono space-y-1">
              <p className="font-bold text-white uppercase">SHADOW ARROW Express Logistics Desk</p>
              <p className="text-slate-400">Support Hours: Monday – Saturday (10:00 AM – 7:00 PM IST)</p>
              <p className="text-blue-400 font-bold">Logistics Helpline Email: support.shadowarrow@gmail.com</p>
            </div>
          </section>
        </div>
      </main>
