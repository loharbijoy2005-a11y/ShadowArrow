...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <Link href={`/product/${id}`} className="group block h-full">
      <div className="bg-[#0d0e0f] border border-[#343535] group-hover:border-[#00e0ff]/60 transition-all duration-300 flex flex-col h-full relative overflow-hidden shadow-lg">
        
        {/* Image Container */}
        <div className="relative aspect-[3/4] sm:aspect-square overflow-hidden bg-[#121414]">
          <img
        ...
        {/* Info Container */}
        <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3 bg-[#0d0e0f]">
          <div>
            ...
            <div className="mt-2.5 inline-flex items-center space-x-1.5 px-2.5 py-1 bg-[#1e2020] border border-[#343535] text-[10px] font-mono font-bold text-amber-400">
          ...
          <div className="pt-3 border-t border-[#343535]/60 flex items-center justify-between">
            <div className="font-mono">
              <span className="text-base sm:text-lg font-bold text-[#00e0ff] bg-[#1e2020] px-2.5 py-1 border border-[#343535]">₹{product.price}</span>
            ...
            <button
              ...
              className={`px-3 sm:px-4 py-1.5 sm:py-2 font-mono text-xs font-bold transition-all duration-300 flex items-center space-x-1.5 uppercase ${
                isOutOfStock
